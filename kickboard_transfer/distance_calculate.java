...
public class distance_calculate { //function of this class is static
	...
	public static double distance_list_sum(double[] list, int start, int end) {
		double sum = 0;
	...
	public static double time_kickboard_sum(Point[] list, int start, int end) {
		double sum = 0;
	...
	public static double time_walk_sum(Point[] list, int start, int end) {
		double sum = 0;
		for(int i = start; i < end; i++) //sum to just before end point
